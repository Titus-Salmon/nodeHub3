...
const {
  nhcrtOptItemSales
} = require('../sqlArch/nhcrtOptItemSales')
// const {
//   nhcrtInfraSalesJoin
// } = require('../sqlArch/nhcrtInfraSalesJoin')
// const {
//   save2CSVnhcrtOptItemSales
// } = require('../sqlArch/save2CSVnhcrtOptItemSales')
// const {
...
router.post('/nhcrtOptItemSales', nhcrtOptItemSales)
// router.post('/nhcrtInfraSalesJoin', nhcrtInfraSalesJoin)
// router.post('/save2CSVnhcrtOptItemSales', save2CSVnhcrtOptItemSales)
