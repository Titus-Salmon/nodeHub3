...
module.exports = {
  loadTable_calcResSFupc_W_rbInvUpdater: router.post('/loadTable_calcResSFupc_W_rbInvUpdater', (req, res, next) => {

    console.log('req.body from /loadTable_calcResSFupc_W_rbInvUpdater ==> ', req.body)
    ...
    connection.query(sqlQuery, (error, response, rows) => {
      if (error) {
        ...
        console.log(`the following querie(s) have been successfully performed from loadTable_calcResSFupc_W_rbInvUpdater.js:
        ...
        res.render('vw-sfUPC_w_RBinvUpdater', {
          title: `vw-sfUPC_w_RBinvUpdater with table headers for <<${tableNameToLoad}>> loaded`,
          loadedTable: {
            tableNameToLoad: tableNameToLoad,
            tableLoadError: loadErrors,
            tableFields: FieldArray,
