...
module.exports = {
  loadTable_calcResPcwGenINFRA: router.post('/loadTable_calcResPcwGenINFRA', (req, res, next) => {

    console.log('req.body from /loadTable_calcResPcwGenINFRA ==> ', req.body)
    ...
    connection.query(sqlQuery, (error, response, rows) => {
      if (error) {
        ...
        console.log(`the following querie(s) have been successfully performed from loadTable_calcResPcwGenINFRA.js:
        ...
        res.render('vw-pcwGenINFRA', {
          title: `vw-pcwGenINFRA with table headers for <<${tableNameToLoad}>> loaded`,
          loadedTable: {
            tableNameToLoad: tableNameToLoad,
            tableLoadError: loadErrors,
            tableFields: FieldArray,
