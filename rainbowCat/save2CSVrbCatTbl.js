...
module.exports = {
  save2CSVrbCatTbl: router.post('/save2CSVrbCatTbl', (req, res, next) => {
    ...
    const fields = [
      "ri_t0d", "prim_key", "vendorName", "ediName", "issueDate", "needNewCat", "updatedWLatest", "reporter", "comments", "andrea",
      "vendorEmail", "ongDisco"
    ]
